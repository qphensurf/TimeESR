...
timepoints='62500 125000 250000 500000'
freqstart=16.8
freqend=17.2
freqdiff=0.04
...
cd $rundir
numtimepoints=`echo "$timepoints" | wc -w`
...
*****************************************************************
@@
echo "Number of Time Points::" $timep
...
# Plot the results
python plot_SpectraESR_compare.py $numtimepoints $timepoints SpectraESR.dat CompareNumTimePoints.png
xdg-open CompareNumTimePoints.png &
